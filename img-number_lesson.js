document.addEventListener("DOMContentLoaded", function () {
  // 1. Добавление изображений в строки с тренировками
  ...
  // 2. Замена текста в статусе пользователя
  ...
  function processLessons() {
    ...
    tdElements.forEach((td, index) => {
      ...
      const lessonIdClass = 'custom-leson-id-' + lessonNumber;
  ...
  function waitForLessons() {
    ...
    if (hasLessons) {
      ...
      // Следим за появлением новых уроков
